...
- ea77e40: deps: [patch|devDependencies] Update package simple-git from 3.32.2 to 3.32.3
- 378a973: deps: [minor|devDependencies] Update package simple-git from 3.32.3 to 3.33.0
- cff3aa5: deps: [minor|devDependencies] Update package simple-git from 3.33.0 to 3.35.1
- 2d6d68b: deps: [patch|devDependencies] Update package simple-git from 3.35.1 to 3.35.2
- be2c187: deps: [minor|devDependencies] Update package simple-git from 3.35.2 to 3.36.0
